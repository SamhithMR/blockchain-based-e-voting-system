...
onLoad(function () {
    ...
    domForEach($(".popup"), function (g) {
        hidePopup(g)
    });
    var b = function () {
        ajaxJson("GET", "/menu", function (n) {
            var l = "",
                o = window.location.pathname;
            for (var k = 0; k < n.menu.length; k += 2) {
                var h = n.menu[k + 1];
